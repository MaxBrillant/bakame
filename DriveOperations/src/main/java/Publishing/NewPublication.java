...
public class NewPublication extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NewPublication frame = new NewPublication();
	...
	public NewPublication() {
		...
		JLabel lblNewLabel = new JLabel("<html><div style='text-align: center;'>Publiez pour notifier les parents et tuteurs des progres des eleves et de leurs situation actuelle</html>");
		...
		JButton newTest = new JButton("<html><div style='text-align: center;'>Publication personnalisee</html>");
		newTest.setVerticalTextPosition(SwingConstants.BOTTOM);
		newTest.setIconTextGap(10);
		newTest.setHorizontalTextPosition(SwingConstants.CENTER);
		newTest.setForeground(Color.WHITE);
		newTest.setFont(new Font("Arial", Font.PLAIN, 19));
		...
		JButton newStudent = new JButton("<html><div style='text-align: center;'>Toutes les publications</html>");
		newStudent.setVerticalTextPosition(SwingConstants.BOTTOM);
		newStudent.setIconTextGap(10);
		newStudent.setHorizontalTextPosition(SwingConstants.CENTER);
		newStudent.setForeground(Color.WHITE);
		newStudent.setFont(new Font("Arial", Font.PLAIN, 19));
		...
		JButton newCourse = new JButton("<html><div style='text-align: center;'>Boite mail</html>");
		newCourse.setVerticalTextPosition(SwingConstants.BOTTOM);
		newCourse.setIconTextGap(10);
		newCourse.setHorizontalTextPosition(SwingConstants.CENTER);
		newCourse.setForeground(Color.WHITE);
		newCourse.setFont(new Font("Arial", Font.PLAIN, 19));
