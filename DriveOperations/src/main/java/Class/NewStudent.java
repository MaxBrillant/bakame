...
Student.deselectAll();
Application.panelStudents.removeAll();
isEmpty = false;
((Container) ((Container) Application.frame.getContentPane().getComponent(1)).getComponent(0)).getComponent(0).setVisible(true);
			...
			((JLabel) ((Container) c.getComponent(0)).getComponent(1)).setText("  "+Home.getStudentName(lines[i].toString()));
				...
				Application.panelStudents.add(c);
			
				Application.panelStudents.revalidate();
				Application.panelStudents.repaint();
			}
		if(Application.panelStudents.getComponentCount()==0) {
			...
			Application.panelStudents.add(panel_10);
...
if(points1==0 && maxima==0 ) {
	...
	((((JLabel) ((Container) ((Container) c).getComponent(1)).getComponent(2)))).setText("Points: "+new DecimalFormat("##.##").format(points1)+"/"+new DecimalFormat("##.##").format(maxima));
	
	((((JLabel) ((Container) ((Container) c).getComponent(1)).getComponent(0)))).setText(new DecimalFormat("##.##").format(percentage)+"%");
	
	((((JLabel) ((Container) ((Container) c).getComponent(1)).getComponent(6)))).setText(String.valueOf(StudentStats.getNumberOfechecs(student_in_classroom_id, "All",
			classroom_in_ay_id, term_id, "All", "All"))+" echecs");
	
	((((JLabel) ((Container) ((Container) c).getComponent(1)).getComponent(8)))).setText(String.valueOf(((List)l.get(6)).toArray().length)+" interros");
	((((JLabel) ((Container) ((Container) c).getComponent(1)).getComponent(12)))).setText("Progres: "+String.valueOf(new DecimalFormat("##.##").format(Double.parseDouble(l.get(5).toString())))+"%");
	}
}
}
