...
public class AccessGranted extends JFrame {
	...
	JLabel lblNouveauCours = new JLabel("<html>La licence d'utilisation du logiciel CiGi Bakame pour la gestion de l'\u00E9tablissement  \""+NewEstablishment.getSchoolName(schoolID)+"\" a \u00E9t\u00E9 renouvell\u00E9e avec succ\u00E8s. Votre licence est valide pour "+days+" jours, soit jusqu'au "+lastDay+".<dynamic></html>");
	...
	btnSinscrire.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			ScholarYears sy = new ScholarYears(Login.getUserId(Login.selectedUserName), NewEstablishment.getSchoolID(UserPanel.selectedSchool), UserPanel.selectedRole);
